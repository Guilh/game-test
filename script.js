...
const LEVELS = {
  1: { name: "Beginner Collector", threshold: 20 },
  2: { name: "Quick Collector", threshold: 40 },
  3: { name: "Master Collector", threshold: 60 },
  4: { name: "Water Wizard", threshold: 80 },
  5: { name: "Legendary Collector", threshold: 100 }
};
...
function showAchievement(message) {
  if (!achievements.includes(message)) {
    ...
    achievementDiv.textContent = `🏆 Achievement Unlocked: ${message}!`;
